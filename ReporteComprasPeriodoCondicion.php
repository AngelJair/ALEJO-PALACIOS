...
<head>
    ...
    <title>Reporte Compras por periodo y coondición</title>
</head>

<body>
    <div>
        <img src="http://<?php echo ($_SERVER['HTTP_HOST']); ?>/Alejo%20Palacios/GrupoAlejo.jpg" alt="...">
        <h1>Compras por periodo y condición</h1>
    </div>
...
$domdf->render();
$domdf->stream("ComprasPeriodoCondicion.pdf", array("Attachment" => false));
