...
<head>
    ...
    <title>Reporte Cobros por Cliente</title>
</head>

<body>
    <div>
        <img src="http://<?php echo ($_SERVER['HTTP_HOST']); ?>/Alejo%20Palacios/GrupoAlejo.jpg" alt="...">
        <h1>Cobros por Cliente</h1>
    </div>

    <br>

    <div class="parametros">
        <h4 class="inline">Condición: <?php echo $Cte ?></h4>
    </div>
...
$domdf->render();
$domdf->stream("CobrosPorCliente.pdf", array("Attachment" => false));
