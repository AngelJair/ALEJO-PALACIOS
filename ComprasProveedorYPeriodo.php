...
<html lang="es">
    ...
    <br>
    <h2>COMPRAS POR PROVEEDOR Y PERIODO</h2>
    <br><br>
    <form class="row px-3" method="post" action="ComprasProveedorYPeriodo.php" id="formulario" class="formulario">
        <div class="container">
            <div class="row">
                <div class="col-md-2">
                        ...
                        <div class="col-md-12">
                            <table class="table table-hover table-bordered text-center">
                                ...
                                <?php
                                    ...
                                    WHERE c.idProveedor= '$Provee' and c.Fecha between '$FI' and '$FF' order by p.Nombre ASC;";
    ...
    <?php
            $archivo_csv=fopen('CompraProveedorPeriodo.csv','w');
            if($archivo_csv){
                $Provee = $_POST['idProveedor'];
                $FI = $_POST['FI'];
                $FF = $_POST['FF'];                                    
                $R="select c.idcompra, p.idProveedor, p.Nombre, c.Fecha, c.FechaVencimiento, c.Factura, 
                     c.Condicion, c.Subtotal, c.IVA, c.Total, c.Saldo
    ...
    ?>
                     <div class="row">
                      <div class="col-12">
                          <br>
                          <a href="CompraProveedorPeriodo.csv" download="CompraProveedorPeriodo.csv" class= "btn btn-primary btn-lg">Descargar Compras Por Proveedor y Periodo CSV</a>
                     </div>
        </div>
    <br><br>
</html>