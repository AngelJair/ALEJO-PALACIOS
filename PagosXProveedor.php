...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#Proveedor').change(function() {
            ...
            if (Prov !== '') { //verificar haber seleccionado una opcion valida
                ...
                $.ajax({
                    ...
                    url: 'PagosXProveedorAjax.php' //url que recibe las variables
