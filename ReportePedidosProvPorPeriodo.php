...
<head>
    ...
    <title>Reporte Pedidos Proveedor por periodo</title>
</head>

<body>
    <div>
        <img src="http://<?php echo ($_SERVER['HTTP_HOST']); ?>/Alejo%20Palacios/GrupoAlejo.jpg" alt="...">
        <h1>Pedidos Proveedor por periodo</h1>
    </div>
...
$domdf->render();
$domdf->stream("PedidosProveedorPorPeriodo.pdf", array("Attachment" => false));
