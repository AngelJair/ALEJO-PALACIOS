...
$FF = $_POST['FF'];
?>
<button class="btn btn-success" onclick="exportTableToExcel('CobrosPorPeriodo', 'CobrosPorPeriodo')">Excel</button>
<a class="btn btn-danger" href="ReporteCobrosPorPeriodo.php?FI=<?php echo $FI ?>&FF=<?php echo $FF ?>" target="_blank">PDF</a>
<br><br>

<table id="CobrosPorPeriodo" class="table table-hover table-bordered text-center">
    <thead>
        <tr>
