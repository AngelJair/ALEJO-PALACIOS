...
<button class="btn btn-success" onclick="exportTableToExcel('VentasVencidas', 'VentasVencidas')">Excel</button>
<a class="btn btn-danger" href="ReporteVentasVencidas.php" target="_blank">PDF</a>
<br><br>

<table id="VentasVencidas" class="table table-hover table-bordered text-center">
    <thead>
        <tr>
