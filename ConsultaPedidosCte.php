...
<html lang="es">
    ...
    <br>
    <h2>PEDIDO POR CLIENTE Y ESTADO</h2>
    <br><br>
    <form class="row px-3" method="post" action="ConsultaPedidosCte.php" id="formulario" class="formulario">
        <div class="container">
            <div class="row">
                <div class="col-md-2">
                            ...
                            <table class="table table-hover table-bordered text-center">
                                ...
                                <?php
                                    ...
                                    if ($Estado == 'Activo') {
                                        ...
                                        $sql = "select p.idPedido, c.idCliente, c.Nombre, p.Fecha, p.FechaEntrega, p.Estado, p.Total
                                                from pedidosclientes as p INNER JOIN clientes as c on p.idCliente = c.idCliente; order by c.Nombre ASC;";
                                        $resultado = mysqli_query($enlace, $sql);
                                    }
                                    while ($fila = mysqli_fetch_array($resultado)) {
                                ?>
                                ...
                                <tr>
                                        ...
                                        <td>
                                            <?php
                                            $query = "SELECT SUM(Total) AS total FROM pedidosclientes";
    ...
    <?php
            ...
            $archivo_csv=fopen('PedidosClienteEstado.csv','w');
            ...
            if($archivo_csv){
                $Cte = $_POST['idCliente'];
                                ...
                                fputs($archivo_csv,"idPedido, idCliente, Nombre, Fecha, FechaEntrega, Estado, Total".PHP_EOL);
    ...
    ?>
                     <div class="row">
                      <div class="col-12">
                          <br>
                          <a href="PedidosClienteEstado.csv" download="PedidosClienteEstado.csv" class= "btn btn-primary btn-lg">Descargar Pedidos Por Cliente Y Estado CSV</a>
                     </div>
                     </div>
