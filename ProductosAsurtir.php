...
<html lang="es">
    ...
    <br><br>
    <form class="row px-3" method="post" action="ProductosAsurtir.php" id="formulario" class="formulario">
        <div class="container">
            <div class = "row">
                        ...
                        <div class="col-md-12">
                            <table class="table table-hover table-bordered text-center">
                                ...
                                <?php
                                    ...
                                    WHERE c.idCategoria= '$idCat' and sc.idSubcategoria= '$idSubcat' and p.Existencia <= p.Minimo order by p.Nombre ASC;     ";
    ...
    <?php
        $archivo_csv=fopen('ProductosASurtir.csv','w');
        if($archivo_csv){
            $idCat = $_POST['idCategoria'];
            $idSubcat = $_POST['idSubCategoria'];
            ...
            $resultado= mysqli_query($enlace,$R);
                            ...
                            fputs($archivo_csv,"idProducto, Nombre, ÚltimoCosto, CostoPromedio, Máximo, Mínimo, Existencia".PHP_EOL);
        ...
        ?>
         <div class="row">
          <div class="col-12">
              <br>
              <a href="ProductosASurtir.csv" download="ProductosASurtir.csv" class= "btn btn-primary btn-lg">Descargar Productos A Surtir CSV</a>
         </div>
    </div>
    <br><br>
</html>